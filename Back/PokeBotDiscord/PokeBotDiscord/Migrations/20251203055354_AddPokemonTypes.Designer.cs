...
namespace PokeBotDiscord.Migrations
{
    ...
    [Migration("20251203055354_AddPokemonTypes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokeBotDiscord.Data.Entities.GymTrainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("Pokemon1Level")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon1SpeciesId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon2Level")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon2SpeciesId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon3Level")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon3SpeciesId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon4Level")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon4SpeciesId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon5Level")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon5SpeciesId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon6Level")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("Pokemon6SpeciesId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PokeBotDiscord.Data.Entities.PokemonSpeciesType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PokemonSpeciesId", "PokemonTypeId")
                        .IsUnique();

                    b.ToTable("PokemonSpeciesTypes");
                });

            modelBuilder.Entity("PokeBotDiscord.Data.Entities.PokemonType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PokeBotDiscord.Data.Entities.PokemonTypeEffectiveness", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PokemonTypeEffectiveness");
                });
            ...
            modelBuilder.Entity("PokeBotDiscord.Data.Entities.PokemonSpeciesType", b =>
                {
                    ...
                    b.HasOne("PokeBotDiscord.Data.Entities.PokemonType", "Type")
                        .WithMany("SpeciesTypes")
            ...
            modelBuilder.Entity("PokeBotDiscord.Data.Entities.PokemonTypeEffectiveness", b =>
                {
                    b.HasOne("PokeBotDiscord.Data.Entities.PokemonType", "AttackerType")
                        .WithMany("AttackingEffectiveness")
                        .HasForeignKey("AttackerTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PokeBotDiscord.Data.Entities.PokemonType", "DefenderType")
                        .WithMany("DefendingEffectiveness")
            ...
            modelBuilder.Entity("PokeBotDiscord.Data.Entities.PokemonType", b =>
                {
                    b.Navigation("AttackingEffectiveness");

                    b.Navigation("DefendingEffectiveness");

                    b.Navigation("SpeciesTypes");
                });
